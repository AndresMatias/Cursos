/*
    video 178 hace lo mismo que Hilos_3 pero con synchronized
 */
package hilos_1;
...
class Banco{
    ...
    public synchronized void transferencia(int origen,int destino, double cantidad) throws InterruptedException{ //Ver lo de throws
...
class EjecucionTransferencia implements Runnable{
    ...
    public EjecucionTransferencia(Banco b,int origen,double max){
        banco=b;
        this.origen=origen;
        cantMax=max;
    }
