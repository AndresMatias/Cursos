 ...
 * @author Andres
 */
public class Eventos_11_Fuentes {
...
class Lamina extends JPanel //Lamina que va encima de mi ventana para empezar a dibujar
{
    ...
    {
        Mi_Color C_1=new Mi_Color("Amarillo",new ImageIcon("src/eventos_11_focos/colors-icon.png"), Color.yellow);
        Mi_Color C_2=new Mi_Color("Azul",new ImageIcon("src/eventos_11_focos/colors-icon.png"), Color.blue);
        Mi_Color C_3=new Mi_Color("Rojo",new ImageIcon("src/eventos_11_focos/colors-icon.png"), Color.red);
