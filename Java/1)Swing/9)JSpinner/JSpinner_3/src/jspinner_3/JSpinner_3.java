...
{   
    ...
    {
        //Variables
        Spinner=new JSpinner(new SpinnerNumberModel(5,0,10,1) //Clase Internar Anonima(interna porque es una clase dentro de otra y anonima porque no tiene nombre (no esta el modificador class y el nombre))
        {
            @Override
