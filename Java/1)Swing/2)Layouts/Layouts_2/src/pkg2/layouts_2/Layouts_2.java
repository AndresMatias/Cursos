/*
 Debo declarar a Mi_Color como clase amiga para no copiarla y pegarla adentro de
Lamina_1 y lamina_2
 Dos laminas una FlowLayouts y otra BorderLayouts, par ver todo debo ampliar
marco(corregir eso)
 */
package pkg2.layouts_2;
...
class Ventana extends JFrame //Creo mi ventana JFrame biblioteca para graficas
{
    ...
    public void Configuracion()
    {
        ...
        L_1=new Lamina_1(Ancho,Alto);//Creo mi clase Lamina
        L_2=new Lamina_2(Ancho,Alto);//Creo mi clase Lamina  
        add(L_1,BorderLayout.NORTH); //Añado mi lamina L_1 sobre el mi Ventana
        add(L_2,BorderLayout.SOUTH); //Añado mi lamina L_2 sobre el mi Ventana
...
class Lamina_1 extends JPanel //Lamina que va encima de mi ventana para empezar a dibujar
{
    int Ancho,Alto;
    //Creo Botones
    ...
    Lamina_1(int Ancho_Aux,int Alto_Aux)
    {
        Ancho=Ancho_Aux;
        Alto=Alto_Aux;
        Configuracion();
    ...
    {
        //Distintas configuraciones para Layout de FlowLayout
            FlowLayout Disposicion= new FlowLayout(FlowLayout.LEFT); //Alineacion por Izquierda
            //FlowLayout Disposicion= new FlowLayout(FlowLayout.CENTER,50,200); //Alineacion en el centro, separacion entre elementos de 150 y separacio del borde superior de 200
        
        //Distintas configuraciones para Layout de BorderLayout
    ...
    class Lamina_2 extends JPanel //Lamina que va encima de mi ventana para empezar a dibujar
    {
        int Ancho,Alto;
        //Creo Botones
            JButton Boton_Amarillo=new JButton("Amarillo"); 
        ...
        Lamina_2(int Ancho_Aux,int Alto_Aux)
        {
            Ancho=Ancho_Aux;
            Alto=Alto_Aux;
            Configuracion();
        ...
        public final void Configuracion()
        {
            ...
            //Agrego Botones a la lamina y sete para que botones se ubiquen en North,West y East
                ...
                add(Boton_Negro,BorderLayout.WEST);
