...
_, binarizada = cv2.threshold(grises2,130,255,cv2.THRESH_BINARY) #(img,umbral,valor a reemplazar si se cumple, tipo de unbralizado)
...
cv2.imshow('Binarizada Invertida',binarizadaINV)
cv2.waitKey(0)
